...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/nandkishor-mali-17b967326/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@nandkishor__22_",
    icon: Instagram,
    url: "https://www.instagram.com/nandkishor__22_/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@nandkishor22",
    icon: Github,
    url: "https://github.com/nandkishor22",
    color: "#ffffff",

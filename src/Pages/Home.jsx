...
const WORDS = ["computer science", "Technology", "web development", "innovation", "creativity"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/nandkishor22" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nandkishor-mali-17b967326/" },
  { icon: Instagram, link: "https://www.instagram.com/nandkishor__22_/?hl=id" }
];
...
const Home = () => {
  ...
  useEffect(() => {
    setIsLoaded(true);
    AOS.refresh(); // Ensure animations refresh after load
  }, []);
